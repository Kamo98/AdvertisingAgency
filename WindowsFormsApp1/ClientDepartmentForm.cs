...
namespace WindowsFormsApp1
{
    ...
    public partial class ClientDepartmentForm : BaseForm
    {
        ...
        {
            gridWrapperClients = new DataGridViewWrapper(dataGridViewClients,ConnectionSettings.npgSqlConnection, qts("Client"), ClientsFields);
            gridWrapperOrders = new DataGridViewWrapper(dataGridViewOrders, ConnectionSettings.npgSqlConnection, qts("AdvertisingOrder"), OrdersFields);
            gridWrapperProjects = new DataGridViewWrapper(dataGridViewProjects, ConnectionSettings.npgSqlConnection, qts("PromotionalProject"), ProjectsFields);
